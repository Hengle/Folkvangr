...
**Role:** Oversees the technical aspects of the animation pipeline, namely layout, rigging, texturing, lighting, rendering, and FX.  This role may be divided among a number of leads if necessary to break up the workload.

**Requirements:** Experience with animation software and studio workflow methods.  Game industry experience preferable.  
