...
It might be possible to automate a script that would create the lines via a filter in a render pass or video composite matte, maybe using a lingering onion skinning effect.
